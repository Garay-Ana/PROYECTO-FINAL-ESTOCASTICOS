...
import PESVLevelModal from '../components/ui/PESVLevelModal';
                  ...
                  <div className="relative z-10">
                    ...
                    <button 
                      onClick={() => {
                        const levelMap = {
                          'Nivel Básico': 'basico',
                          'Nivel Estándar': 'estandar',
                          'Nivel Avanzado': 'avanzado'
                        };
                        setModalLevel(levelMap[level.level]);
                      }}
                      className="w-full mt-8 py-3 px-4 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold rounded-lg transition-all duration-300 shadow-md hover:shadow-lg"
                    >
                      Conocer más
                    </button>
                  </div>
