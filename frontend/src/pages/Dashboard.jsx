...
import { Users, Truck, ClipboardList, CheckSquare, Bell, AlertTriangle, TrendingUp, Sparkles, DollarSign, ShieldCheck, ChevronDown } from "lucide-react";
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          {/* Alertas activas */}
          <div className="bg-white rounded-xl p-5" style={{ boxShadow: "var(--shadow)" }}>
            <div className="flex items-center justify-between mb-4 cursor-pointer" onClick={() => setAlertasVisible(!alertasVisible)}>
              <div>
              ...
              <div className="flex items-center gap-2">
                ...
                <ChevronDown size={16} style={{ color: "var(--text-muted)", transition: "transform 0.2s", transform: alertasVisible ? "rotate(180deg)" : "rotate(0deg)" }} />
              </div>
            </div>
            {alertasVisible && (
              <>
