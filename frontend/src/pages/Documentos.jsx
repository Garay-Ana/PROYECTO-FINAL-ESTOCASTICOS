    ...
    },
    {
      ...
      render: (_, row) => (
        <div className="flex items-center gap-2">
          ...
          <button onClick={() => handleDescargar(row)} className="p-1 rounded hover:bg-gray-100" title="Descargar">
      ...
      <Modal open={modalVer} onClose={() => setModalVer(false)} title={docSeleccionado?.titulo || "Documento"} size="lg">
        {docSeleccionado && (
          <div>
            ...
            <pre className="text-sm whitespace-pre-wrap leading-relaxed rounded-xl p-4 overflow-auto" style={{ backgroundColor: "var(--bg-input)", border: "1px solid var(--border)", color: "var(--text-primary)", maxHeight: "70vh", fontFamily: "DM Mono, monospace", fontSize: 12 }}>
