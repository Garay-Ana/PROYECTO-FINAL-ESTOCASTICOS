      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-bold text-white text-lg">Ana Garay y compañia</p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <a href="mailto:gabygaray1414@gmail.com" className="text-gray-400 hover:text-blue-400 transition-colors font-medium break-all">
                  gabygaray1414@gmail.com
                </a>
              </li>
              <li className="flex items-start gap-3">
                <Phone className="w-5 h-5 text-blue-400 flex-shrink-0 mt-0.5" />
                <a href="tel:+573103718829" className="text-gray-400 hover:text-blue-400 transition-colors font-medium">
                  +57 3103718829
                </a>
              </li>
              <li className="flex items-start gap-3">
                <MapPin className="w-5 h-5 text-blue-400 flex-shrink-0 mt-0.5" />
                <span className="text-gray-400 font-medium">Monteria- cordoba</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <p className="text-sm text-gray-400 text-center md:text-left">
            © {currentYear} Ana Garay y compañia. Todos los derechos reservados. | Resolución 40595 de 2022 - Ministerio de Transporte de Colombia
          </p>
